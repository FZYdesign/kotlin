...
fun KtExpression.guessTypes(
    ...
    if (theType1 != null && !ErrorUtils.containsErrorType(theType1)) {
    ...
    if (theType2 != null && !ErrorUtils.containsErrorType(theType2)) return arrayOf(theType2)
    ...
    return when {
        ...
        parent is KtFunction -> {
            ...
            if (returnType != null && !ErrorUtils.containsErrorType(returnType)) return arrayOf(returnType)
